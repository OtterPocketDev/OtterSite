...
Vue.component("color-2", {
  template:
    '<link rel="stylesheet" type="text/css" href="/static/color/color-2.css" />'
});
Vue.component("color-3", {
  template:
    '<link rel="stylesheet" type="text/css" href="/static/color/color-3.css" />'
});
export default {
  name: "color",
  data() {
